  ...
  switch (status.type) {
    case 'loading':
      return (
        <Badge
          variant="secondary"
          className="gap-1.5 text-xs text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-950/50 border-blue-200 dark:border-blue-900"
        >
        ...
        <Tooltip>
          <TooltipTrigger
            render={
              <span className="inline-flex">
                <Badge
                  variant="outline"
                  className="gap-1 text-xs text-emerald-600 dark:text-emerald-400 bg-emerald-50/50 dark:bg-emerald-950/30 border-emerald-300 dark:border-emerald-800 cursor-help"
                >
          ...
          <TooltipContent className="text-xs">
            ...
            <p className="text-muted-foreground">
              Точек растра: {status.dataPointsCount.toLocaleString()}
            </p>
