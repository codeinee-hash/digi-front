...
export const LayerItem: React.FC<LayerItemProps> = React.memo(({ layerId, showRenderCount = true }) => {
      ...
      <CardContent className="p-4 space-y-3.5">
        ...
        <div className="flex items-center justify-between text-xs pt-1 border-t border-border/40">
          ...
          {showRenderCount && (
            ...
            >
              renders: <span className="font-semibold text-foreground">{renderCountRef.current}</span>
            </div>
          )}
        </div>
